...
- `compliance-attestation.md`: the attestation-program glossary (every `AttestationProgram` token, its governance family, and its conformance role) and the achievement-themes appendix mapping tokens to the six Product Achievements themes.
