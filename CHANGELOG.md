...
- Each missing requirement now carries a machine-readable roadmap (the conformance level it unlocks, the source document that supplies it, and the governing standard) at every climb, including out of `incomplete` into `core`.
